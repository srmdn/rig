...
1. Open a PR adding your skill to a `community/skills/` directory
2. Include a README explaining what it does and when to use it
3. Link it in the community config page
